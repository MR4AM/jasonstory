...
(function (window) {
  ...
  function gradientColor(startColor,endColor,step){
    var startRGB,startR,startG,startB,endRGB,endR,endG,endB, sR, sG, sB;
    ...
    constructor(props, context) {
     ...
     gauge(canvas,points){
      ...
      componentDidMount(){
        ...
        var canvas=this.gauge(my_canvas_obj1,30); 
    }
    render() {
        return (
            <div className="cavanns">
                <canvas width={510} height={510} id="gauge1"></canvas>
                <div className="point point_30"></div>
          </div>
        );
    }
  }
